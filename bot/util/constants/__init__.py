...
class Client(NamedTuple):
    ...
    default_prefix = "?"
    guild_id = 1099905841945116742
    test_guild_id = 1099905841945116742
...
class RapidApi:
    ...
    print("Rapid AI not Implemented")
...
class Spotify:
    ...
    print("Spotify API not implemented")
