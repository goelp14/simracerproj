from cogs import About, Activity, Channels, Calculator, Cogs, Config, Create_ACC_Server, Docs, Eval, Fun, Games, Help, InviteTracker, Music, Ping, Slash, SubCommands, Suggestion, Moderation
def unload(bot) -> None:
    """
...
def setup(bot):
    ...
    bot.add_cog(Create_ACC_Server.Create_ACC_Server(bot))
